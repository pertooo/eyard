 ...
 */
package prt.navitruck.back.app.service.redis;
...
//    }
    ...
    public void setValue(final String key, final String value, TimeUnit unit, long timeout, boolean marshal) {
        if (marshal) {
            template.setHashValueSerializer(new Jackson2JsonRedisSerializer<>(Object.class));
            template.setValueSerializer(new Jackson2JsonRedisSerializer<>(Object.class));
        } else {
    ...
    public void setExpire(final String key, final long datetime){
        template.expire(key, datetime, TimeUnit.MINUTES);
    }
